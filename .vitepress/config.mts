...
export default defineConfig({
  ...
  head: [
    [
      'link',
      { rel: 'icon', href: '/brand/notionnext-logo.png', type: 'image/png' }
    ],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: '更新日志',
        link: '/user-guide/changelog/latest',
        activeMatch: '/user-guide/changelog/'
      },
      {
        text: '主题',
      ...
      '/user-guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: 'Vercel 加速',
              link: '/user-guide/deploy/vercel-accelerate'
            },
            {
              text: 'Vercel 多站点',
              link: '/user-guide/deploy/vercel-multi-sites'
            },
            {
              text: 'Vercel 重新部署',
              link: '/user-guide/deploy/vercel-redeploy'
            },
            {
              text: 'Vercel 静态导出',
              link: '/user-guide/deploy/vercel-static'
            },
            {
              text: 'Cloudflare 文档站',
              link: '/user-guide/deploy/cloudflare-pages-docs'
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: '定时发布',
              link: '/user-guide/notion/notionnext-scheduled-article-release'
            },
            { text: '视频嵌入', link: '/user-guide/notion/notionnext-video' },
            {
              text: '双语库翻译 CLI',
              link: '/user-guide/notion/bilingual-translator'
            }
          ]
        },
        {
          ...
          items: [
            ...
            {
              text: '内联配置',
              link: '/user-guide/config/notion-next-inline-config'
            },
            {
              text: '文章封面图',
              link: '/user-guide/config/notion-next-image-cover'
            },
            {
              text: '缓存配置',
            ...
            {
              text: '网页字体',
              link: '/user-guide/config/notion-next-web-font'
            },
            {
              text: 'Font Awesome',
              link: '/user-guide/config/notion-next-font-awesome'
            },
            {
              text: 'Iconfont',
              link: '/user-guide/config/notion-next-iconfont'
            },
            {
              text: '代码样式',
              link: '/user-guide/config/notion-next-code-style'
            },
            {
              text: '自定义属性',
              link: '/user-guide/config/notion-next-custom-properties'
            },
            {
              text: '文章复制权限',
            ...
            {
              text: '多站点聚合',
              link: '/user-guide/config/notion-next-site-combine'
            },
            {
              text: 'API Base URL',
              link: '/user-guide/config/notion-next-api_base_url'
            },
            {
              text: 'GitHub 图床',
              link: '/user-guide/config/use-github-as-image-hosting-service'
            },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Umami', link: '/user-guide/analytics/umami' },
            {
              ...
              link: '/user-guide/analytics/clarity'
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: 'Live2D 宠物',
              link: '/user-guide/plugins/notion-next-plugin-live2d'
            },
            { text: 'Algolia 搜索', link: '/user-guide/config/algolia' },
            {
              text: 'Google AdSense',
              link: '/user-guide/plugins/notion-next-google-adsense'
            },
            {
              text: 'Coze AI 聊天机器人',
              link: '/user-guide/plugins/notion-next-coze'
            },
            {
              text: 'Chatbase AI 聊天机器人',
              link: '/user-guide/plugins/notion-next-chat-base'
            },
            {
              text: 'Facebook 聊天插件',
              link: '/user-guide/plugins/notion-next-facebook-chat-plugn'
            },
            {
              text: 'SaleSmartly 聊天插件',
              link: '/user-guide/plugins/notion-next-salesmatly-pulgin'
            },
            {
              text: 'Tidio 聊天插件',
              link: '/user-guide/plugins/notion-next-tidio'
            },
            {
              text: 'Mailchimp 邮件订阅',
              link: '/user-guide/plugins/mailchimp'
            }
          ]
        },
        {
          ...
          items: [
            {
              text: '开发入门',
              link: '/user-guide/development/getting-started'
            },
            { text: '运行原理', link: '/user-guide/development/architecture' },
            {
              text: '前端开发教程',
              link: '/user-guide/development/frontend-development-tutorial'
            },
            {
              text: '自定义样式',
              link: '/user-guide/development/custom-style'
            },
            {
              text: '开发自己的主题',
              link: '/user-guide/development/own-theme'
            },
            {
              text: '鼠标点击特效',
              link: '/user-guide/development/notion-next-click-effect'
            },
            {
              text: 'AI 辅助开发',
              link: '/user-guide/development/notion-next-develop-with-ai'
            },
            {
              text: '如何提交 PR',
              link: '/user-guide/development/notionnext-how-to-pr'
            },
            { text: 'React JSX', link: '/user-guide/development/react-jsx' },
            { text: 'Next.js', link: '/user-guide/development/nextjs' },
            {
              text: 'Tailwind CSS',
              link: '/user-guide/development/about-tailwindcss'
            }
          ]
        },
        {
          ...
          items: [
            ...
            {
              text: '搜索引擎收录',
              link: '/user-guide/operations/search-engine-index'
            },
            {
              text: '微信公众号',
              link: '/user-guide/operations/wechat-offical-account'
            }
          ]
        },
        {
          ...
          items: [
            ...
            {
              text: '支持 NotionNext',
              link: '/user-guide/help/support-notion-next'
            },
