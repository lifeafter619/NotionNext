 ...
 */
const Style = () => {
  const primary = starterConfig(
    'STARTER_COLOR_PRIMARY',
    CONFIG.STARTER_COLOR_PRIMARY,
    CONFIG
  )
  const primaryHover = starterConfig(
    'STARTER_COLOR_PRIMARY_HOVER',
    CONFIG.STARTER_COLOR_PRIMARY_HOVER,
    CONFIG
  )
  const dark = starterConfig(
    'STARTER_COLOR_DARK',
    CONFIG.STARTER_COLOR_DARK,
    CONFIG
  )
  const textMuted = starterConfig(
    'STARTER_COLOR_TEXT_MUTED',
    CONFIG.STARTER_COLOR_TEXT_MUTED,
    CONFIG
  )
