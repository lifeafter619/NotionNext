    ...
    <style jsx global>{`
      ...
      #theme-fuwari.fuwari-bg {
        background:
          radial-gradient(
            circle at 10% -10%,
            var(--fuwari-primary-soft) 0,
            transparent 45%
          ),
          radial-gradient(
            circle at 100% 10%,
            rgba(122, 199, 255, 0.14) 0,
            transparent 35%
          ),
          var(--fuwari-bg);
      }
      ...
      #theme-fuwari .fuwari-footer {
        border-top: 1px dashed
          color-mix(in oklab, var(--fuwari-border) 85%, transparent);
        background: transparent;
      }
      #theme-fuwari .fuwari-copy-btn {
        border: 1px solid
          color-mix(in oklab, var(--fuwari-primary) 24%, var(--fuwari-border));
        background: color-mix(
          in oklab,
          var(--fuwari-primary) 8%,
          var(--fuwari-surface)
        );
        color: color-mix(
          in oklab,
          var(--fuwari-primary) 80%,
          var(--fuwari-text)
        );
      ...
      #theme-fuwari .fuwari-tool-btn {
        ...
        border: 1px solid
          color-mix(in oklab, var(--fuwari-border) 75%, transparent);
        background: color-mix(in oklab, var(--fuwari-bg-soft) 82%, #fff);
        color: color-mix(
          in oklab,
          var(--fuwari-primary) 56%,
          var(--fuwari-muted)
        );
        font-size: 0.86rem;
        display: inline-flex;
      ...
      #theme-fuwari .fuwari-meta-icon {
        ...
        border: 1px solid
          color-mix(in oklab, var(--fuwari-primary) 16%, var(--fuwari-border));
      }
      ...
      #theme-fuwari .fuwari-social-btn {
        ...
        background: color-mix(
          in oklab,
          var(--fuwari-primary) 10%,
          var(--fuwari-surface)
        );
        border: 1px solid
          color-mix(in oklab, var(--fuwari-primary) 22%, var(--fuwari-border));
      ...
      #theme-fuwari .fuwari-card,
      #theme-fuwari #posts-wrapper > article {
        animation: fuwari-enter 0.28s ease both;
      }
