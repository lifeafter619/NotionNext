  ...
  return (
    <>
      ...
      <button
        ...
        className='fixed right-4 bottom-24 z-40 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border border-gray-200 bg-white text-gray-400 shadow-md transition-all duration-300 hover:-translate-y-1 hover:border-[#FBFB46] hover:bg-[#FBFB46] hover:text-black hover:shadow-lg md:hidden'
        title='Table of Contents'>
        {/* Show Percentage by default, Icon logic similar to desktop for consistency */}
        <div className='relative w-full h-full flex items-center justify-center'>
          <span className='text-[10px] font-bold font-mono group-hover:hidden text-gray-400'>
            {Math.round(progress)}%
          </span>
          <ListCheck2Icon
            size={20}
