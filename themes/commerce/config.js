const CONFIG = {
  ...
  COMMERCE_COLOR_BG_DARK: '#111827',
  COMMERCE_COLOR_CARD_DARK: '#1f2937',
  COMMERCE_COLOR_TEXT_DARK: '#f9fafb',

  // 封面大图
  COMMERCE_HOME_BANNER_ENABLE: true,
  COMMERCE_HOME_NAV_BACKGROUND_IMG_FIXED: false,

  // 菜单
  COMMERCE_MENU_INDEX: true,
  COMMERCE_MENU_CATEGORY: true,
  COMMERCE_MENU_TAG: true,
  COMMERCE_MENU_ARCHIVE: true,
  COMMERCE_MENU_SEARCH: true,

  // 文章列表与详情
  COMMERCE_POST_LIST_COVER_DEFAULT: true,
  COMMERCE_POST_LIST_COVER_HOVER_ENLARGE: false,
  COMMERCE_POST_LIST_SUMMARY: true,
  COMMERCE_ARTICLE_ADJACENT: true,
  COMMERCE_ARTICLE_RECOMMEND: true,

  // Widget
  COMMERCE_WIDGET_ANALYTICS: false,
  COMMERCE_WIDGET_LATEST_POSTS: true,
  COMMERCE_WIDGET_TO_COMMENT: true,
  COMMERCE_WIDGET_TO_TOP: true,
  COMMERCE_WIDGET_DARK_MODE: true,
  COMMERCE_WIDGET_TOC: true,
