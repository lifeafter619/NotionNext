...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '24f4d291ba2c806c8850ddcb3fe8c012',
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 3600, // 更新缓存间隔 单位(秒)；即每个页面有3600秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=66619.eu.org', // 备案查询链接，如果用了萌备等备案请在这里填写
