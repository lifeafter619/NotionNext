...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '生活,技术,619, 𝟞𝟙𝟡'𝕤 𝔹𝕃𝕆𝔾,619's blog,619's Blog,博客', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,weibo,email,facebook,twitter,telegram,messenger,reddit,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://waline-1-s4770081.deta.app', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
