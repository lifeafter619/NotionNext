...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '24f4d291ba2c806c8850ddcb3fe8c012',
  ...
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'system', // ['light', 'system', 'dark']; 'auto' 兼容为跟随系统
  ...
  PWA_ICON_192: process.env.NEXT_PUBLIC_PWA_ICON_192 || '', // 可选：覆盖 manifest 192x192 普通图标；须提供真实 192x192 尺寸的资源路径
  PWA_ICON_512: process.env.NEXT_PUBLIC_PWA_ICON_512 || '', // 可选：覆盖 manifest 512x512 普通图标；须提供真实 512x512 尺寸的资源路径
  ...
  BEI_AN_LINK:
    ...
    'https://icp.gov.moe/?keyword=66619.eu.org', // 备案查询链接，如果用了萌备等备案请在这里填写
