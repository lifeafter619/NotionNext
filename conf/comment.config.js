...
module.exports = {
  ...
  COMMENT_WALINE_SERVER_URL:
    process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://waline.619.pp.ua', // 请配置完整的Waline评论地址 例如 https://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
