...
| 目录                                             | 说明                        |
| ------------------------------------------------ | --------------------------- |
| [themes/README.md](./developer/themes/README.md) | 主题长文、存根、英文副本    |
| [themes/CLAUDE.md](./themes/CLAUDE.md) 等        | 含全局 `_app.js` 等实现细节 |

## 其它

| 路径                                                     | 说明                         |
| -------------------------------------------------------- | ---------------------------- |
| [performance/](./performance/)                           | 主题性能审计记录             |
| [../DOCUMENTATION_POLICY.md](../DOCUMENTATION_POLICY.md) | 文档维护策略（同时在线发布） |
